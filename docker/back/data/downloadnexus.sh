...
NEXUS_BASE=${NEXUS_BASE-:http://localhost:8081/nexus}
...
EXAMPLE SNAPSHOT:
    $ NEXUS_BASE=http://repository.company.com/nexus ./downloadJarFromNexus.sh -iorg.example:demo:1.0.0-SNAPSHOT:LATEST-SNAPSHOT -p jar -v
EXAMPLE RELEASE:
    $ NEXUS_BASE=http://repository.company.com/nexus ./downloadJarFromNexus.sh -iorg.example:demo:1.0.0:LATEST -p jar
EOF
}
